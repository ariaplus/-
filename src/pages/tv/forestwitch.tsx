...
export default function ForestWitch(): JSX.Element {
    ...
    <MainContainer>
      ...
      <MainHeader useActionButton title='Forest Witch' action={back}>
        <div className='flex flex-col items-center p-8 bg-no-repeat bg-top bg-contain -mt-[100px]' style={{ backgroundImage: 'url(/assets/tv/movie/data/forestwitch/cover.jpg)' }}>
          <NextImage
            src='/assets/tv/movie/data/forestwitch/fw.png'
            alt=''
            width={250}
            height={125}  
          ...
          <div className='flex gap-[10px] h-[80px] -mt-[9px] '>
            <div className='flex'>  
              <AImage
                src='/main/ui/tertiary/elements/tv/premieroriginals.svg'
                alt=''
                width={200}
                height={125}  
          ...
          <div className='flex pt-[7px] gap-[10px] ml-[40px] '>
            <Button
              className='accent-tab bg-main-accent enabled:hover:bg-main-accent/90 enabled:active:bg-main-accent/75 hover:bg-blue-700 text-white font-bold py-2 px-4 w-80 rounded-lg'
            >
              Play
            </Button>
            <TvPassModal />
...
ForestWitch.getLayout = (page: ReactElement): ReactNode => (
  <ProtectedLayout>
    <MainLayout>
