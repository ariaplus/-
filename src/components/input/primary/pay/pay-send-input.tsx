...
// Update the inputId type to accept specific string values along with EditableData
export type InputFieldProps = {
  label: string;
  inputId: EditableData | "recipient" | "amount"; // Updated type definition
...
export function PaySendInputField ({
  label,
  inputId,
  inputValue,
  inputLimit,
      ...
      >
        {useTextArea ? (
          <textarea
            ...
            id={inputId.toString()} // Corrected to convert inputId to string
            placeholder={inputId.toString()} // Corrected to convert inputId to string
        ...
        <label
          ...
          htmlFor={inputId.toString()} // Corrected to convert inputId to string
        >
          {label}
        </label>
        {inputLimit && (
...
export type InputFieldProps = {
  ...
  inputValue: string | null | undefined; // Modified to accept undefined as well
  inputLimit?: number;
  useTextArea?: boolean;
  errorMessage?: string;
  handleChange: (
