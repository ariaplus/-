...
const Music = ({ title, image, description, href }: EpisodeProps) => {
  ...
  return (
      <Link className='w-48 h-48 rounded-lg border-solid border-white bg-opacity-50' href={href}>
    <div className='bg-cover bg-center p-4 m-2 w-64 h-48 opacity-100 rounded-lg border-solid border-white bg-opacity-50' style={{ backgroundImage }}>
        <a className='h-32'>
